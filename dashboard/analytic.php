            ...
            <div class="contain">
                ...
                <div class="dash_body">
                    <div class="inner_dash_body payments_dash">
                        <div class="blk">
                            <ul class="blans">
                                <li>Total Amount: <span class="price">$7560.0</span></li>
                                <li>Discount Obtained: <span class="price">$1,258.5</span></li>
                                <li>Available Balance: <span>$8650</span></li>
                                <li>
                                    <div class="btn_blk">
                                        <a href="javascript:void(0)" class="webBtn default-btn pop_btn" data-popup="withdraw">Add New Payment</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
